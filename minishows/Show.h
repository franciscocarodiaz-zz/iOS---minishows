...
- (instancetype)initWithName:(NSString *)name andEpisode:(NSString *)episode andGeneralInfo:(NSString *)generalInfo andOverview:(NSString *)overview andImage:(NSString *)image;
